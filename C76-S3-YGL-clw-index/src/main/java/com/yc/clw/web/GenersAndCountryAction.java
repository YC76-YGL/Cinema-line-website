...
public class GenersAndCountryAction implements IclwalltableAction{
	...
	public List<ClwMovielist> getnewmovie() {
		...
		ClwMovielist cml = new ClwMovielist();
		cml.setId(1);
		cml.setName("肖申克的救赎");
		...
		list.add(cml);
		ClwMovielist cml1 = new ClwMovielist();
		cml1.setId(2);
		cml1.setName("教父");
	...
	@Override
	public List<ClwMovielist> getcountrmovie(Integer page, Integer id) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public List<ClwMovielist> getalmovie(Integer page) {
		// TODO Auto-generated method stub
		return null;
	}
