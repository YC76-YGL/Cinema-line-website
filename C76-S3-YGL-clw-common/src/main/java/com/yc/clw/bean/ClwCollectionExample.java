...
public class ClwCollectionExample {
	...
	protected abstract static class GeneratedCriteria {
		...
		public Criteria andUserCollectionThisIsNotNull() {
			addCriterion(" DATE_FORMAT( createtime,'%Y%m' ) = DATE_FORMAT( CURDATE( ) , '%Y%m' ) and user is not null");
			return (Criteria) this;
		}
		
		public Criteria andUserCollectionLastIsNotNull() {
		...
		public Criteria andUserLastmouthCollectionEqualTo(Integer value) {
			addCriterion(" PERIOD_DIFF( date_format( now( ) , '%Y%m' ) ,"
					+ " date_format( createtime, '%Y%m' ) ) = 1 and user =", value, "user");
			return (Criteria) this;
		}

		public Criteria andUserFirstmouthCollectionEqualTo(Integer value) {
			addCriterion(" PERIOD_DIFF( date_format( now( ) , '%Y%m' ) ,"
					+ " date_format( createtime, '%Y%m' ) ) = 2 and user =", value, "user");
			return (Criteria) this;
		}
